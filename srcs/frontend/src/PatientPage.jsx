      ...
      <div className="p-5 bg-white rounded shadow text-center" style={{ maxWidth: "600px", width: "100%" }}>
        ...
        {selectedExercise && (
          <div className="mt-4">
            ...
            >
              {isStreaming ? "End Exercise" : "Start Exercise"}
            </button>
            {isStreaming && <CameraStream startStreaming={isStreaming} stopStreaming={!isStreaming} />}
          </div>
        )}
      </div>
    </div>
...
//     <div className="d-flex flex-column align-items-center justify-content-center vh-100" style={{ backgroundColor: "#F3E5F5" }}>
//       <div className="p-5 bg-white rounded shadow text-center" style={{ maxWidth: "600px", width: "100%" }}>
//         <h1 className="text-purple-600 mb-4">Your videos:</h1>
//         <div className="d-flex flex-wrap justify-content-center">
//           {videos.map((video) => (
...
//                 <video
//                   className="embed-responsive-item"
//                   src={`http://localhost:8000/videos/${video.id}/download`}
//                   controls
//                 ></video>
//               </div>
//               <p className="text-center mt-2 mb-2" style={{ color: "#4B0082" }}>{video.filename}</p>
//               {video.has_document && (
//                 <button
//                   className="btn btn-sm mt-2"
//                   style={{ backgroundColor: "#D8BFD8", color: "#4B0082" }}
//                   onClick={() => window.open(`http://localhost:8000/videos/${video.id}/document/download`)}
//                 >
//                   Download Document
//                 </button>
//               )}
